...
# from core.permissions import IsCustomerOrCompanyWorker
...
#                 self.permission_classes = []
#             case "monitoring":
#                 self.permission_classes = [IsCustomerOrCompanyWorker]
#             case _:
...
#                     case "COMPANY":
#                         return MeCompanyWorkerSerializer
#                     case "CUSTOMER":
#                         return MeCustomerSerializer
#                     case _:
