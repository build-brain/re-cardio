...
class Patient(User):
    ...
    created_doctor = models.ForeignKey(
    ...
    curator_doctor = models.ForeignKey(
        verbose_name=_("Curator doctor"), 
        to="Doctor",
    ...
    passport_serial_number = models.CharField(
        verbose_name=_("Passport serial and number"), 
        max_length=9, 
        null=True, 
        blank=True
    )
    ...
    age = models.SmallIntegerField(verbose_name=_("Age"))
    ...
    social_group = models.CharField(
        verbose_name=_("Social group"),
        max_length=20,
        choices=SocialGroupChoices.choices,
        null=True,
        blank=True
    )
