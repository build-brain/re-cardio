...
from .choices import (
    ...
    ProfessionChoices,
    ConditionChoices,
    DiagnosedByTypeChoices,
    HospitalizationTypeChoices
)
...
class User(AbstractUser, PermissionsMixin):
    ...
    # passport_attachment = models.FileField(verbose_name=_("Passport attachment"), upload_to="uploads/passport/% Y/% m/% d/", null=True, blank=True)
...
class Patient(User):
    ...
    created_doctor = models.ForeignKey(verbose_name=_("Created doctor"), to=Doctor, related_name="created_patients", on_delete=models.SET_NULL, null=True)
    curator_doctor = models.ForeignKey(verbose_name=_("Curator doctor"), to=Doctor, related_name="patients", on_delete=models.SET_NULL, null=True)
