...
from src.er_card.utils import get_file_path_ca_sheet
from src.er_card.choices import second_stage as second_choices
...
class SecondStageData(models.Model):
    ...
    heart_rhythm = models.CharField(verbose_name=_("Heart rhythm"), max_length=50, choices=second_choices.HeartRhythmChoices.choices)
    ...
    left_ventricle_decreased_pumping_function = models.CharField(
        ...
        choices=second_choices.EjectionFractionChoices.choices
    ) 
    ...
    heart_rhythm_disorders_type = models.CharField(
        verbose_name=_("Heart rhythm disorders type"), max_length=20,
        choices=second_choices.HeartRhythmChoices.choices, null=True, blank=True
    )
...
class MyocardialNecrosisBiochemicalMarker(models.Model):
    ...
    second_stage = models.ForeignKey(
        verbose_name=_("Second stage data"), to=SecondStageData, 
    ...
    file = models.FileField(verbose_name=_("MNBM file"), upload_to=get_file_path_ca_sheet)
...
class AdditionalTestResult(models.Model):
    ...
    file = models.FileField(verbose_name=_("File"), upload_to=get_file_path_ca_sheet)
