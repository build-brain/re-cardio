    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lethality_start', models.FloatField(blank=True, null=True, verbose_name='Lethality percentage start')),
                ('lethality_end', models.FloatField(blank=True, null=True, verbose_name='Lethality percentage end')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Create date')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Update date')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ca_sheets', to='management.doctor', verbose_name='Created doctor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attachment', models.FileField(max_length=255, upload_to=src.er_card.utils.get_file_path_er_card, verbose_name='Attachment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('complications_group_1', models.ManyToManyField(blank=True, related_name='diagnoses_group_1', to='er_card.complication', verbose_name='Group 1 complications')),
                ('complications_group_2', models.ManyToManyField(blank=True, related_name='diagnoses_group_2', to='er_card.complication', verbose_name='Group 3 complications')),
                ('complications_group_3', models.ManyToManyField(blank=True, related_name='diagnoses_group_3', to='er_card.complication', verbose_name='Group 3 complications')),
                ('ca_sheet', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='clinical_diagnosis', to='er_card.conditionassessmentsheet', verbose_name='Condition Assessment sheet')),
                ('grace', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='er_card.gracescale', verbose_name='GRACE Scale')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=50, verbose_name='Name')),
                ('description', models.TextField(blank=True, verbose_name='Description')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='medications', to='er_card.medicationgroup', verbose_name='Medication group')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ca_sheet', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='first_stage', to='er_card.conditionassessmentsheet', verbose_name='Condition Assessment sheet')),
                ('medication_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ca_sheets', to='er_card.medication', verbose_name='Medication name')),
                ('medication_group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ca_sheets', to='er_card.medicationgroup', verbose_name='Medication group')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pulse_rate', models.FloatField(blank=True, null=True, verbose_name='Radial artery pulse rate')),
                ...
                ('heart_rhythm', models.CharField(choices=[('normal_sinus', 'Normal sinus rhythm'), ('arrhythmia', 'Arrhythmia of any kind'), ('ex_rhythm', 'EX rhythm')], max_length=50, verbose_name='Heart rhythm')),
                ...
                ('ecg_attachment', models.FileField(blank=True, null=True, upload_to='uploads/ecg/', verbose_name='ECG attachment')),
                ('ecg_additional', models.FileField(blank=True, null=True, upload_to='uploads/ecg/', verbose_name='ECG additional')),
                ...
                ('echocg_attachment', models.FileField(blank=True, null=True, upload_to='uploads/echocg/', verbose_name='EchoCG attachment')),
                ('echocg_additional', models.FileField(blank=True, null=True, upload_to='uploads/echocg/', verbose_name='EchoCG additional')),
                ...
                ('heart_rhythm_disorders_type', models.CharField(blank=True, choices=[('normal_sinus', 'Normal sinus rhythm'), ('arrhythmia', 'Arrhythmia of any kind'), ('ex_rhythm', 'EX rhythm')], max_length=20, null=True, verbose_name='Heart rhythm disorders type')),
                ...
                ('hm_ecg_attachment', models.FileField(blank=True, null=True, upload_to='uploads/hm_ecg/', verbose_name='Holter Monitoring ECG attachment')),
                ('hm_ech_additional', models.FileField(blank=True, null=True, upload_to='uploads/hm_ecg/', verbose_name='Holter Monitoring ECG additional')),
                ('ca_sheet', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='second_stage', to='er_card.conditionassessmentsheet', verbose_name='Condition Assessment sheet')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to=src.er_card.utils.get_file_path_ca_sheet, verbose_name='MNBM file')),
                ('second_stage', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mnbm_data', to='er_card.secondstagedata', verbose_name='Second stage data')),
            ],
            options={
                'verbose_name': 'Myocardial necrosis biochemical marker',
                'verbose_name_plural': 'Myocardial necrosis biochemical markers',
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=90, verbose_name='Title')),
                ('file', models.FileField(upload_to=src.er_card.utils.get_file_path_ca_sheet, verbose_name='File')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Create date')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Update date')),
                ('second_stage', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='additional_test_results', to='er_card.secondstagedata', verbose_name='Second stage data')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ca_attached', models.FileField(blank=True, null=True, upload_to='uploads/coronary_angiography/')),
                ('ca_sheet', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='third_stage', to='er_card.conditionassessmentsheet', verbose_name='Condition Assessment sheet')),
            ],
            options={
                'verbose_name': 'First stage data',
                'verbose_name_plural': 'First stage data',
