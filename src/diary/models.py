...
class HealthDiaryRecord(models.Model):
    ...
    general_condition = models.CharField(
        verbose_name=_("General Condition"), max_length=20,
        choices=GeneralConditionChoices.choices, null=True, blank=True
    )
    ...
    pulse_on_exertion = models.CharField(
        verbose_name=_("Blood Pressure and Pulse on Exertion"), 
        max_length=40, choices=PulseOnExertionChoices.choices, null=True, blank=True
    )
    ...
    breathing_rhythm = models.CharField(
        verbose_name=_("Breathing Rhythm"), max_length=20, 
        choices=BreathingRhythmChoices.choices, null=True, blank=True
    )
    ...
    dyspnea_type = models.CharField(
        verbose_name=_("Dyspnea Type"), max_length=20, 
        choices=DyspneaTypeChoices.choices, null=True, blank=True
    )
    fatigue = models.BooleanField(verbose_name=_("Fatigue"), null=True, blank=True)
    fatigue_type = models.CharField(
        verbose_name=_("Fatigue Type"), max_length=255, 
        choices=FatigueTypeChoices.choices, null=True, blank=True
    )
    heart_pain = models.BooleanField(verbose_name=_("Heart Pain"), null=True, blank=True)
    heart_pain_type = models.CharField(
        verbose_name=_("Heart Pain Type"), max_length=255, 
        choices=HeartPainTypeChoices.choices, null=True, blank=True
    )
    ...
    borg_scale = models.PositiveSmallIntegerField(
        verbose_name=_("Borg Scale Perception of Physical Effort"), 
        choices=BorgScalePerceptionOfPhysicalEffortChoices.choices, null=True, blank=True
    )
