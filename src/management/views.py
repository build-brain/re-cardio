...
class DistrictViewSet(viewsets.ModelViewSet):
    ...
    """District model view set"""

    queryset = District.objects.all()
    serializer_class = DistrictSerializer

    
class PatientAttachmentViewSet(viewsets.ModelViewSet):

    """Patient attachment model view set"""
